    ...
    const socialIcon = [
        {
            ...
            href: "https://www.instagram.com/lilian_atob",
            icon: "Instagram"
        },
            ...
            <div className="container">
                <div className="">
                    <div className="w-full h-72">
                        <Image src={"/banner.jpeg"} alt="banner-img" width={1080} height={267} className="w-full h-full object-cover" />
                    </div>
                    <div className="border-x border-primary/10">
                        <div className="relative flex flex-col xs:flex-row items-center xs:items-start justify-center xs:justify-between max-w-3xl mx-auto gap-10 xs:gap-3 px-4 sm:px-7 pt-22 pb-8 sm:pb-12">
                            <div className="absolute top-0 transform -translate-y-1/2">
                                <div className="w-[145px] h-[145px] rounded-full overflow-hidden border-4 border-white">
                                    <Image
                                        src={"/images/hero-sec/lilian.jpeg"}
                                        alt="user-img"
                                        width={145}
                                        height={145}
                            ...
                            <div className="flex flex-col md:flex-row items-center gap-4">
                                <div className="flex items-center gap-2">
                                    {socialIcon?.map((value, index) => {
                                        return (
                                            <Link href={value?.href} target="blank" key={index} className="w-fit p-2.5 sm:p-3.5 hover:bg-primary/5 border border-primary/10 rounded-full">
                                    ...
                                    <a
                                        href="mailto:lilianatobatele9@gmail.com"
